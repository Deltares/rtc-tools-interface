...
goal_table_column_spec = {
    ...
    "function_min": {"allowed_types": [int, float, str], "allowed_values": None, "required": False},
    "function_max": {"allowed_types": [int, float, str], "allowed_values": None, "required": False},
    "function_nominal": {"allowed_types": [int, float, str], "allowed_values": None, "required": False},
