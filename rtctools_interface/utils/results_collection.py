...
class PlottingBaseMixin(ReadGoalsMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.plot_config = get_plot_config(
            plot_table_file, plot_config_list, read_from, csv_list_separator=self.csv_list_separator
        )
        ...
        if not hasattr(self, "_all_goal_generator_goals") and self.optimization_problem:
            ...
            read_from = kwargs.get("read_goals_from", "csv_table")
            self.load_goals(
                read_from, goals_to_generate, csv_list_separator=self.csv_list_separator
            )
